 ...
 */
class FacturacionControllerFacturacionDelete extends FacturacionController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('FacturacionDelete', 'FacturacionModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_facturacion') || $user->authorise('core.edit.state', 'com_facturacion')) {
            $model = $this->getModel('Facturacion', 'FacturacionModel');
    ...
    public function remove() {
        ...
        //Checking if the user can remove object
        $user = JFactory::getUser();
        if ($user->authorise($user->authorise('core.delete', 'com_facturacion'))) {
            $model = $this->getModel('Facturacion', 'FacturacionModel');
